// MOCK MIRROR of components/BrainActivityFeed.tsx — identical UI, but fetches
// the mock brain/activity route (staging data).
"use client";
...
export default function BrainActivityFeed({
  ...
  const fetchActivity = async () => {
    try {
      const url = sessionId
        ? `/mock/api/brain/activity?sessionId=${sessionId}&limit=50`
        : `/mock/api/brain/activity?limit=50`;
