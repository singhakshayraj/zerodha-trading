// MOCK MIRROR of components/OpenPositions.tsx — identical UI, but uses the
// no-redirect mock axios. The open-positions / holdings endpoints aren't
// mirrored, so calls 404 and are swallowed (non-fatal) — seeded trades are all
// CLOSED, so there are no open positions to show anyway.
"use client";
