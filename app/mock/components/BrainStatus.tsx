// MOCK MIRROR of components/BrainStatus.tsx — identical UI, but polls the mock
// brain/status route via the no-redirect mock axios so it reads staging data
// and never bounces to /connect.
"use client";
